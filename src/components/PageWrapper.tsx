...
export default function PageWrapper({ children }: { children: ReactNode }) {
    return (
        <>
            <main className={'relative z-10 min-h-[80vh] h-full w-full px-16 md:px-52 py-20'} role={"main"}>
                {children}
            </main>
            <div className={'fixed z-0 bottom-0 w-full rotate-180 overflow-hidden'} role={"banner"}>
                <svg
                ...
                >
                    <path
                        className={"fill-lightGreen origin-center"}
                        style={{
                            fillOpacity: "0.4",
